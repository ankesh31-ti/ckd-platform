...
import { LayoutDashboard, Bell, MessageSquare, ScanLine, User, Activity, ClipboardPlus } from 'lucide-react';

const links = [
  { to: '/', icon: LayoutDashboard, label: 'Dashboard' },
  { to: '/data-entry', icon: ClipboardPlus, label: 'Add Patient Data' },
